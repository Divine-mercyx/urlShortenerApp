...
export default function LoginScreen() {
    ...
    const url = "https://urlshortener-etcr.onrender.com/api/v1/login"
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await AsyncStorage.setItem("user", JSON.stringify(data.existingUser))
    ...
    return (
        <View style={styles.container}>
            <View>
                <Text className="text-sky-400 text-2xl">Welcome <Text className="text-white">Back</Text></Text>
            </View>
            ...
            <View className="w-full p-5">
                ...
                <TouchableOpacity onPress={() => navigation.navigate("Signup")} className="mb-6 text-right">
                    <Text className="text-gray-500 text-right">Don't have an account?</Text>
                </TouchableOpacity>
